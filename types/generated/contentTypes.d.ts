...
export interface ApiDispositifIntroDispositifIntro
  extends Struct.SingleTypeSchema {
  collectionName: "dispositif_intros";
  info: {
    displayName: "DispositifIntro";
    pluralName: "dispositif-intros";
    singularName: "dispositif-intro";
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiFicheFiche extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    intro: Schema.Attribute.Blocks;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::fiche.fiche"> &
      Schema.Attribute.Private;
    parties: Schema.Attribute.Component<"shared.partie", true>;
    publishedAt: Schema.Attribute.DateTime;
    sousTitre: Schema.Attribute.String;
...
export interface ApiFiliereFiliere extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    romeCode_GrandDomaines: Schema.Attribute.JSON;
    titre: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private;
...
export interface ApiFormationDureeFormationDuree
  extends Struct.CollectionTypeSchema {
  collectionName: "formation_durees";
  info: {
    displayName: "FormationDuree";
    pluralName: "formation-durees";
    singularName: "formation-duree";
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiFormationNiveauFormationNiveau
  extends Struct.CollectionTypeSchema {
  collectionName: "formation_niveaus";
  info: {
    displayName: "FormationNiveau";
    pluralName: "formation-niveaus";
    singularName: "formation-niveau";
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiFormationFormation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    alternance: Schema.Attribute.Boolean;
    certificat: Schema.Attribute.String;
    contact: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private;
    filieres: Schema.Attribute.Relation<"oneToMany", "api::filiere.filiere">;
    formationDuree: Schema.Attribute.Relation<
      "oneToOne",
      "api::formation-duree.formation-duree"
    >;
    ...
    origine: Schema.Attribute.Enumeration<
      ["ONISEP", "Alternance", "Site", "AEM"]
    >;
...
export interface ApiMetierMetier extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    centresInterets: Schema.Attribute.Component<
      ...
      true
    >;
    codeRomeMetier: Schema.Attribute.Component<"shared.rome-code", false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private;
    ...
    tachesQuotidiennes: Schema.Attribute.Component<
      "shared.titre-et-description",
      true
    >;
...
export interface ApiOrientationOrientation extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    voies_de_formation: Schema.Attribute.Component<
      ...
      true
    >;
    voies_de_formation_diagramme: Schema.Attribute.Media<"images" | "files">;
  };
}
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      [
        "B\u00E2tisseur",
        "Financeur",
        "Concepteur et relecteur",
        "Institutionnel et ressource",
      ]
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
